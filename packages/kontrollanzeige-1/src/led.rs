use esp_idf_sys::{
    ...
    rmt_get_counter_clock, rmt_item32_s__bindgen_ty_1, rmt_item32_s__bindgen_ty_1__bindgen_ty_1,
    rmt_item32_t, rmt_mode_t_RMT_MODE_TX, rmt_translator_init, rmt_tx_config_t, rmt_wait_tx_done,
    rmt_write_sample, size_t, u_int8_t,
};
pub use rgb::RGB8;
...
unsafe extern "C" fn ws2812_to_rmt(
    ...
    let mut bit0: rmt_item32_s__bindgen_ty_1__bindgen_ty_1 = Default::default();
    ...
    let mut bit1: rmt_item32_s__bindgen_ty_1__bindgen_ty_1 = Default::default();
